...
//       {/* Chat Panel */}
//       {open && (
//         <div className="absolute bottom-16 right-0 w-[360px] max-h-[520px] bg-brand-dark/75 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-fade-up">
//           {/* Header */}
//           <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10">
//             <div className="w-9 h-9 rounded-full bg-gradient-to-br from-brand-cyan to-brand-orange flex items-center justify-center text-brand-dark text-xs font-bold">
//               AI
//             </div>

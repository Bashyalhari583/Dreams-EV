    ...
    <div className="pt-20">
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            <div
              ...
              style={{
                height: 420,
                background:
                  "radial-gradient(ellipse at 50% 60%, rgba(25,215,255,.07) 0%, transparent 70%)",
            ...
            <div className="flex gap-3 justify-center">
              {vehicle.gallery.map((img, i) => (
                <button
                  ...
                  className="rounded-xl overflow-hidden border-2 transition-colors flex items-center justify-center"
                  style={{
                    width: 90,
                    height: 70,
                    flexShrink: 0,
                    ...
                    borderColor:
                      img === mainImage ? "#19d7ff" : "rgba(255,255,255,.1)",
                    padding: ".35rem",
                  }}
                >
                  <img
          ...
          <div>
            ...
            <div className="glass p-5 mb-6">
              ...
              <h2 className="text-2xl font-display font-bold text-brand-orange">
                {vehicle.price}
              </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="glass p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {vehicle.features.map((f) => (
                <span
                  key={f}
                  className="px-3 py-1.5 bg-white/5 rounded-full text-sm text-white/70"
                >
                  {f}
                </span>
              ))}
          ...
          <div className="glass p-6">
            <h2 className="font-display font-bold text-lg mb-4">
              {isEV ? "Battery Information" : "Engine Information"}
            </h2>
            <p className="text-white/60 text-sm leading-relaxed">
              {isEV
          ...
          <div className="glass p-6 md:col-span-2">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              {vehicle.emi}. Down payment, tenure, and approval are subject to
              dealer and finance partner confirmation.
            </p>
          </div>
        </div>
